...
import warnings
from ua_detector.generic_views import MobileMixin
from ua_detector import utilities

__all__ = (
     'ModelDetailView','ModelCreateView','ModelListView',
     'ModelUpdateView','ModelDeleteView','CustomCreateView'
)
...
## The concrete model views: less verbose

class ModelListView(GenericModelView,View):
...
class ModelDetailView(GenericModelView,View):
...
class ModelCreateView(GenericModelView,View):
    success_url = None
...
class ModelUpdateView(GenericModelView,View):
    success_url = None
    template_name_suffix = '_form'
...
class ModelDeleteView(GenericModelView,View):
    success_url = None
...
class CustomCreateView(GenericModelView,View):
    success_url = None
    template_name_suffix = '_form'
